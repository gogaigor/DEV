<div class="c-block">
    <div class="c-title"><img alt="Blog-W.Ru" id="ico-news" src="{theme}/images/news.png">&nbsp;&nbsp;&nbsp;&nbsp;Обратная связь</div>
    <div class="c-page">
        ...
        <button name="send_btn" class="button1" type="submit"><span>Отправить</span></button>
    </div>
</div>