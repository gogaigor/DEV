...
<div class="content-title">Добавление новости</div>
<div class="content-news">
	...
	<div class="fieldsubmit">
		<button name="add" class="button" type="submit"><span>Отправить</span></button>
		<button name="nview" onclick="preview()" class="button" type="submit"><span>Просмотр</span></button>
	</div>
    </div>